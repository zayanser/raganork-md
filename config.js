...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || ';𝗭𝗔𝗬𝗔𝗡;𝗭𝗔𝗬𝗔𝗡𝗦𝗘𝗥;https://i.imgur.com/YhsU62k.jpeg;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "𝗭𝗔𝗬𝗔𝗡;𝗭𝗔𝗬𝗔𝗡",
    BOT_NAME: process.env.BOT_NAME || '𝗭𝗔𝗬𝗔𝗡𝗦𝗘𝗥',
